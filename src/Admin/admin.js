...
function Admin() {
    ...
    return (
        <div className='Admin'>
                        ...
                        return (
                            <tr>
                                ...
                                <td>{student.studentID}
                                    ...
                                    <button
                                        onClick={(e) => { setStudentID(Math.floor(Math.random()*899999+100000)) }}
                                        style={{ display: adminEdit === students.indexOf(student) + 1 ? "" : "none" }} className='admin-edit' type='text' placeholder='student id'>
                                        Generate ID
                                    </button>
                                    {/* <p>{studentID}</p> */}
            ...
            <button className='get-users' onClick={() => { getUsers('instructor-data', 'student-data') }}>view all students</button> <br /> <br />
            <button className='get-users' onClick={() => { getUsers('student-data', 'instructor-data') }}>view all instructors</button>
